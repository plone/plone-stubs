...
myst:
  html_meta:
    "description": "Documentation for Plone Stubs"
    "property=og:description": "Documentation for Plone Stubs"
    "property=og:title": "Plone Stubs"
    "keywords": "Plone Stubs, documentation, Documentation for Plone Stubs"
---

# Plone Stubs

Welcome to the documentation for Plone Stubs!
