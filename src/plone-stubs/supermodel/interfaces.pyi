...
class IXMLToSchema(Interface):
    ...
    """
    def xmlSchema(self, filename, schema: str = "", policy: str = "") -> None:
        ...
        """
    def loadFile(self, filename, reload: bool = False, policy: str = "") -> None:
        ...
        ISchemaPolicy.
        """
    def loadString(self, model, policy: str = "") -> None:
        """Load a model from a string rather than a file."""
    def serializeSchema(self, schema, name: str = "") -> None:
        ...
        """
    def serializeModel(self, model) -> None:
...
class ISchemaPolicy(Interface):
    ...
    """
    def module(self, schemaName, tree) -> None:
        """Return the module name to use."""
    def bases(self, schemaName, tree) -> None:
        """Return the bases to use."""
    def name(self, schemaName, tree) -> None:
...
class IFieldExportImportHandler(Interface):
    ...
    def write(self, field, fieldName, fieldType, elementName: str = "field") -> None:
