...
def default_timezone(fallback: str = "UTC"):
...
def is_same_time(start, end, exact: bool = False):
...
def utcoffset_normalize(date, delta=None, dstmode=...):
...
def pydt(dt, missing_zone=None, exact: bool = False):
...
def rfc2445dt(dt, mode: str = "utc", date: bool = True, time: bool = True):
