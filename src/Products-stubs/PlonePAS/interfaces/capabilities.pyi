...
class IDeleteCapability(Interface):
    ...
    For Plone UI.
    """
    def allowDeletePrincipal(id) -> None:
...
class IGroupCapability(Interface):
    ...
    For Plone UI.
    """
    def allowGroupAdd(principal_id, group_id) -> None:
        """True iff this plugin will allow adding a certain principal to a
        certain group."""
    def allowGroupRemove(principal_id, group_id) -> None:
...
class IAssignRoleCapability(Interface):
    ...
    For Plone UI.
    """
    def allowRoleAssign(id, role) -> None:
