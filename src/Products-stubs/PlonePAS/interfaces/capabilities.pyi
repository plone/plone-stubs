...
class IDeleteCapability(Interface):
    ...
    For Plone UI.
    """
    def allowDeletePrincipal(self, id) -> None:
...
class IPasswordSetCapability(Interface):
    ...
    For Plone UI.
    """
    def allowPasswordSet(self, id) -> None:
...
class IGroupCapability(Interface):
    ...
    For Plone UI.
    """
    def allowGroupAdd(self, principal_id, group_id) -> None:
        """True iff this plugin will allow adding a certain principal to a
        certain group."""
    def allowGroupRemove(self, principal_id, group_id) -> None:
...
class IAssignRoleCapability(Interface):
    ...
    For Plone UI.
    """
    def allowRoleAssign(self, id, role) -> None:
